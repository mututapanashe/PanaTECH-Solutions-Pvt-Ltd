...
export class Navbar {
    ...
    setupIntersectionObserver() {
        ...
        this.heroSection = document.querySelector('.hero-section, .about-hero, .service-hero, .maintenance-hero, .custom-software-hero, .mobile-hero, .ai-hero, .cloud-hero, .cyber-hero, .portfolio-hero');
